...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ── Featured Properties ──────────────── */}
      <section className="section" style={{ paddingTop: 'var(--space-8)', paddingBottom: 'var(--space-6)' }}>
        <div className="container">
      ...
      <section className="section" style={{ paddingTop: 'var(--space-8)', background: '#FAFAFA url(/whybg.png) no-repeat top center', backgroundSize: '100% auto', overflow: 'hidden', position: 'relative' }}>

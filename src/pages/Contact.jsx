    ...
    <>
      ...
      <div className="page-header page-header--properties animate-in" style={{ backgroundImage: 'url(/properties.png)' }}>
        <div className="container">
          <h1 className="page-header__title" style={{ fontSize: 'var(--text-4xl)' }}>Contact Us</h1>
        </div>
      </div>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container">
          {/* Info Cards */}
          <div className="grid grid--3 contact-info-cards stagger-wrap" ref={cardsRef} style={{ marginTop: '32px' }}>
            ...
            <a href="tel:+919325650256" className="info-card">
              ...
              <div>
                ...
                <div className="info-card__value">+91 93256 50256</div>
              </div>
            </a>
